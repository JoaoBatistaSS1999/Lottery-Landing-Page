...
const Header = () => {
  ...
  return (
    <header className="w-full flex bg-[#001535] text-white font-bold justify-center">
      <div className="max-w-screen-2xl w-full flex justify-between items-center p-3">
        ...
        <div className="hidden lg:flex sm:gap-2">
          <ul className="flex">
            <li className="flex justify-center items-center w-28 border-r">
              Home
            </li>
            <li className="flex justify-center items-center w-28 border-r">
              Dex
            ...
            <li className="flex justify-center items-center w-28 ">Docs</li>
          </ul>

          <button className="flex gap-1 justify-center items-center border-2 border-[#2AD5FB] text-[#2AD5FB] w-[195px] h-[41px] rounded-[21px] ">
