const Banner = () => {
	return (
		<div className="w-full flex flex-col justify-center bg-transparent h-96 py-5  ">
			...
			<div className="max-w-screen-2xl mx-auto w-full text-white pt-0 flex flex-col items-center gap-5 text-3xl sm:text-[43px] lg:flex-row lg:text-[50px] lg:justify-center font-bold">
